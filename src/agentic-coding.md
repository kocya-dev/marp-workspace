...
- 極力 AI に作業を任せること
  - 適切なコンテキストを与えること
  - コンテキストウィンドウが溢れないようタスクを分割すること
  - AI の出力を制御するガードレールを整備すること
...
※instructions がどこに影響するか、や instructions の内容の参照関係を記述しても良いかも
...
- UI 周り
  - スクロールバーが画面によって表示される/されないでずれる
    - overflow:scroll や scrollbar-gutter の css を適切な位置に記述できない  
      ※できた！→ できてない x 3
  - 水平方向のセンタリングができない
    - display: flex および justify-content: center の css を適切な位置に記述できない
      ※できた！→ できてない x 3
